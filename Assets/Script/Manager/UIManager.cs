...
public class UIManager : MonoBehaviour
{
    ...
    public void addUIMenu(UI_InfoType _infoType,List<object> _obj = null)
    {
        make_UI(_infoType, _obj);
    }

    private void make_UI(UI_InfoType _InfoType, List<object> _obj = null)
    {
        UIBase uIBase = null;
        ...
        GameObject tempUI = create_UIObj(_InfoType);
    ...
    private GameObject create_UIObj(UI_InfoType _infoType)
    {
        if ((int)_infoType < m_UIObjArr.Length)
        {
            string _uiobjectPos = m_UIObjArr[(int)_infoType];
            return Instantiate(Resources.Load(_uiobjectPos)) as GameObject;
        }
        return null;
    }
